...
class BenchmarkService:
    def __init__(
        ...
        *,
        ...
        self._driver_preflight = DriverPreflight()
    ...
    def _run_preflight(self, plan: BenchmarkPlan, job_id: str) -> dict[str, Any]:
        return self._driver_preflight.run(
            plan,
            job_id,
            runner=self.runner,
            runner_options=self._runner_options(job_id),
        )
    ...
    def preflight(self, action: Any, job_id: str) -> dict[str, Any]:
        ...
        return self._driver_preflight.freeze(action, plan, preflight)
